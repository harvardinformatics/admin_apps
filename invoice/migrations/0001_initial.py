...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invoice_invoice', (
            ...
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 1, 0, 0))),
        ))
    ...
    models = {
        ...
        'invoice.invoice': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 1, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('facility_facility', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default='', auto_now=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        'facility.facility': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': "''", 'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
